...
const mapDispatchToProps = (dispatch) => ({
  setSelectedSong: (track, albumImg) => {
    dispatch(setSelectedSongAction(track, albumImg))
  },
})

const Song = ({ track, selectedSong, setSelectedSong, albumImg }) => (
  <div
    className="py-3 trackHover d-flex"
    onClick={() => setSelectedSong(track, albumImg)}
  >
    <span
